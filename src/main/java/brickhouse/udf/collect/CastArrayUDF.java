...
public class CastArrayUDF extends GenericUDF {
    ...
    private Object coerceObject(Object stdObj) {
        // LOG.debug("Casting " + stdObj + " from " + fromInspector.getPrimitiveCategory() + " to " + toInspector.getPrimitiveCategory() + " of type " + toInspector.getTypeName());
        if (stdObj == null) {
            return null;
        }
    ...
    private static PrimitiveObjectInspector GetObjectInspectorForTypeName(String typeString) {
        ...
        // LOG.debug("Type for " + typeString + " is " + typeInfo);
